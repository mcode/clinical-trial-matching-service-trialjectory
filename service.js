...
const scriptPath = path.resolve(path.join(__dirname, 'start.js'));
const workingDirectory = path.resolve(__dirname);

const svc = new Service({
  name: 'Clinical Trial Matching Service - Trialjectory',
  description: 'Clinical Trial Matching Service wrapper for the Trialjectory matching service.',
  script: scriptPath,
