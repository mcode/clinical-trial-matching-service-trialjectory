import * as mappinglogic from "../src/trialjectorymappinglogic";
...
import { Bundle, Resource } from "clinical-trial-matching-service/dist/fhir-types";
...
//   // Initialize
//   const extractedMCODE = new TrialjectoryMappingLogic(null);
//   const tm: mappinglogic.TumorMarker = {};
//   tm.coding = [] as fhir.Coding[];
//   tm.interpretation = [] as fhir.Coding[];
//   tm.valueCodeableConcept = [] as fhir.Coding[];
//   tm.valueQuantity = [] as mappinglogic.Quantity[];
//   tm.valueRatio = [] as mappinglogic.Ratio[];
...
//   tm.coding.push({ system: 'http://loinc.info/sct', code: '16112-5', display: 'N/A' } as fhir.Coding); // Any code in 'Biomarker-ER'
//   tm.valueRatio.push({numerator: {value: 6, comparator: '>', unit: '%'}, denominator: {value: 3, comparator: '>', unit: '%'}, metric: '>'} as mappinglogic.Ratio);
...
//   tm.coding.push({ system: 'http://loinc.info/sct', code: '85310-1', display: 'N/A' } as fhir.Coding); // Any code in 'Biomarker-ER'
//   tm.valueRatio.push({numerator: {value: 1, comparator: '<', unit: '%'}, denominator: {value: 101, comparator: '<', unit: '%'}, metric: '<'} as mappinglogic.Ratio);
//   extractedMCODE.tumorMarker.push(tm);
//   const tumorMarkerValues: string[] = extractedMCODE.getTumorMarkerValue()
//   it('Test ER- Filter_2', () => {
//     expect(tumorMarkerValues[0]).toBe('ER-');
...
//   tm.valueQuantity.push({ value: '51', comparator: '>', unit: '%', code: '%' } as mappinglogic.Quantity);
//   extractedMCODE.tumorMarker.push(tm);
...
//   tm.coding.push({ system: 'http://loinc.info/sct', code: '42795-5', display: 'N/A' } as fhir.Coding); // Any code in 'Biomarker-RB'
//   tm.valueQuantity.push({ value: '49', comparator: '<=', unit: '%', code: '%' } as mappinglogic.Quantity);
//   extractedMCODE.tumorMarker.push(tm);
...
//   tm.valueQuantity.push({ value: '3+', comparator: '=' } as mappinglogic.Quantity);
//   extractedMCODE.tumorMarker.push(tm);
...
//   tm.coding.push({ system: 'http://loinc.info/sct', code: '32996-1', display: 'N/A' } as fhir.Coding); // Any code in 'Biomarker-HER2'
//   tm.valueQuantity.push({ value: '2+', comparator: '=' } as mappinglogic.Quantity);
//   extractedMCODE.tumorMarker.push(tm);
...
//   tm.valueQuantity.push({ value: '1', comparator: '>=', unit: '%', code: '%' } as mappinglogic.Quantity);
//   extractedMCODE.tumorMarker.push(tm);
...
//   tm.coding.push({ system: 'http://loinc.info/sct', code: '42785-6', display: 'N/A' } as fhir.Coding); // Any code in 'Biomarker-FGFR'
//   tm.valueQuantity.push({ value: '0.5', comparator: '<', unit: '%', code: '%' } as mappinglogic.Quantity);
//   extractedMCODE.tumorMarker.push(tm);
...
//   const extractedMCODE = new TrialjectoryMappingLogic(null);
//   const crsp: mappinglogic.CancerRelatedSurgicalProcedure = {};
//   crsp.reasonReference = [] as mappinglogic.ReasonReference;
